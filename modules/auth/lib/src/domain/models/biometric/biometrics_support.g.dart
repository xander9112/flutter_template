...
_BiometricSupportModel _$BiometricSupportModelFromJson(
  Map<String, dynamic> json,
) => _BiometricSupportModel(
  status:
      $enumDecodeNullable(_$BiometricStatusEnumMap, json['status']) ??
...
Map<String, dynamic> _$BiometricSupportModelToJson(
  _BiometricSupportModel instance,
) => <String, dynamic>{
