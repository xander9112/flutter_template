...
import 'package:auth/src/data/dto/auth_failure_mapper.dart';
...
class AuthRepository implements IAuthRepository<TokensDTO, UserEntity> {
  ...
  @override
  Future<Either<AuthFailure, TokensDTO>> signIn(
    String login,
    String password,
  ) async {
    try {
  ...
  @override
  Future<Either<AuthFailure, TokensDTO>> signUp(
    String login,
    String password,
  ) async {
    try {
  ...
  Future<Either<AuthFailure, bool>> signOut() async {
    try {
      ...
      if (e.type == DioExceptionType.unknown) {
        return Left(AuthFailure(code: 'UNKNOWN', message: ''));
      }
  ...
  @override
  Future<Either<AuthFailure, AuthenticatedUser>> getUserData() async {
    try {
  ...
  Future<Either<AuthFailure, AuthenticatedUser>> getCurrentUser() async {
    try {
      ...
      return Left(AuthFailure(code: 'UNKNOWN', message: 'User not found'));
    } catch (e) {
      return Left(AuthFailure(code: 'UNKNOWN', message: e.toString()));
    }
  }
  ...
  @override
  Future<Either<AuthFailure, void>> setCurrentUser(UserEntity user) async {
    try {
