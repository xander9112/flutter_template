...
class _RestRemoteAuthDataSource implements RestRemoteAuthDataSource {
  _RestRemoteAuthDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<TokensDTO> refreshToken({required String token}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = token;
    final _options = _setStreamType<TokensDTO>(
    ...
    final _result = await _dio.fetch<Object>(_options);
    late TokensDTO _value;
    try {
      _value = TokensDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
